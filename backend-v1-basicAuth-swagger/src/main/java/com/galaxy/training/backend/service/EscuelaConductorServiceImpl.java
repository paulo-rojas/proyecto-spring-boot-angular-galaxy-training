...
import com.galaxy.training.backend.exception.DepartamentoNoExistenteException;
import com.galaxy.training.backend.exception.DistritoNoExistenteException;
import com.galaxy.training.backend.exception.EscuelaConductorDuplicadoException;
import com.galaxy.training.backend.exception.EscuelaConductorNoExistenteException;
import com.galaxy.training.backend.exception.ProvinciaNoExistenteException;
import com.galaxy.training.backend.mapper.EscuelaConductorMapper;
import com.galaxy.training.backend.repository.EscuelaConductorRepository;
...
public class EscuelaConductorServiceImpl implements EscuelaConductorService {
    ...
    public EscuelaConductorResponseDto updateEscuelaConductor(Integer id,
        ...
        direccionService.deleteDireccion(escuelaConductorEntity.getDireccion());
        DireccionEntity direccionEntity = direccionService.createDireccion(escuelaConductorRequestDto.getDetalleDireccion(), escuelaConductorRequestDto.getDistritoId());
        escuelaConductorEntity.setDireccion(direccionEntity);
